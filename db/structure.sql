...
CREATE TABLE `condition_cart_summary_labels` (
  ...
  `cart_summary_label_id` bigint DEFAULT NULL,
...
CREATE TABLE `condition_product_sort_fields` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `condition_id` bigint DEFAULT NULL,
  `product_sort_field_id` bigint DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `conditions` (
  ...
  `default_sort_field_id` bigint DEFAULT NULL,
...
CREATE TABLE `custom_product_attributes` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `condition_id` bigint DEFAULT NULL,
  `product_attribute_csv_file_id` bigint DEFAULT NULL,
...
CREATE TABLE `custom_sortings` (
  ...
  `condition_id` bigint DEFAULT NULL,
  `sort_file_id` bigint DEFAULT NULL,
  `product_id` bigint DEFAULT NULL,
...
CREATE TABLE `product_suggestions` (
  ...
  `suggestion_csv_file_id` bigint DEFAULT NULL,
  `condition_id` bigint DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `products` (
  ...
  `calories_from_fat` int DEFAULT NULL,
