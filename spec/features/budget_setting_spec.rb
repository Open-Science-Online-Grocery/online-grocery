...
RSpec.describe 'Configuring condition budgeting settings', :feature do
  ...
  it 'allows budgeting configuration', :js do
    ...
    expect(find_by_id('condition_may_add_to_cart_by_dollar_amount')).not_to be_checked
    ...
    expect(find_by_id('condition_may_add_to_cart_by_dollar_amount')).to be_checked
